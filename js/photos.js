var photos = [
    {
        ...
        "comment": [
            ...
            "甘孜<br/>甘孜藏族自治州位于四川省西部，康藏高原东南。总面积15.3万平方公里，是一个以藏族为主体民族的地级行政区。",
            "",
            "镰刀湾",
            "天葬台吃尸体的丌鹫<br/>天葬是蒙古族、藏族等少数民族的一种传统丧葬方式，人死后把尸体拿到指定的地点让鹰（或者其他的鸟类、兽类等）吞食，天葬核心是灵魂不灭和轮回往复，死亡只是不灭的灵魂与陈旧的躯体的分离。",
			"色达五明佛学院<br/>全称是色达县喇荣寺五明佛学院，坐落在四川省甘孜藏族自治州色达县境县城东南方约20公里处，海拔4000米上。在重重的群山环绕之中，沟里的僧舍，以佛学院的大经堂为中心，密密麻麻搭满了四面的山坡，不计其数的绛红色小木屋，延绵无数，一眼望不到头。",
			"浮桥头"
        ]
    },
    {
