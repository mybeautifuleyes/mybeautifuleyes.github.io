...
function init_gallery(){
    ...
    // init classify
    gallery_html += '<div class="col-md-12 text-center">' +
    ...
    for (var i = 0; i < gallery_imgs.length; i++){
        gallery_html += '<div class="mix ' + gallery_imgs[i].classify + ' col-md-4">' +
            '<a href="' + gallery_imgs[i].img + '" class="img-wrapper">' +
            '<img class="img-responsive" src="' + gallery_imgs[i].img + '" />' +
            '</a></div>';
    }
    gallery_html += '</div>';
